...
function handleToolResult(params: any) {
  // Only mount the view once. After mount, the view manages its own
  // data via useKit().reload(). Ignore subsequent tool-result notifications
  // that carry the stale initial snapshot.
